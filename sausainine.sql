...
(1, 'Sausainiai su vyšniomis', 3),
(2, 'Sausainiai su razinomis', 2.5),
(3, 'Sausainiai su šokoladu', 2),
(4, 'Sausainiai su karamele', 3.5),
(5, 'Sausainiai be priedų', 1.5);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_vartotojo_id` (`user`),
  ADD KEY `fk_item_id` (`product`);
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_item_id` FOREIGN KEY (`product`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `fk_vartotojo_id` FOREIGN KEY (`user`) REFERENCES `users` (`id`);
COMMIT;
